...
public class RegistryHandler {
    ...
    public static <T extends BlockEntity> BlockEntityType<T> blockEntity(Identifier id, Supplier<T> supplier,
            Block... blocks) {
        return Registry.register(Registry.BLOCK_ENTITY_TYPE, id,
                BlockEntityType.Builder.create(supplier, blocks).build(null));
    }

    public static ConfiguredStructureFeature<?, ?> configuredFeature(Identifier id,
    ...
    public static <S extends RecipeSerializer<T>, T extends Recipe<?>> S recipeSerializer(String recipeId,
            S serializer) {
        return RecipeSerializer.register(recipeId, serializer);
    }

    public static <T extends ScreenHandler> ScreenHandlerType<T> screenHandler(Identifier id,
