...
public class LumberjackTradeOffers {
  ...
  public static class EmeraldsForOverworldLogs extends SingleItemTypeTrade {
    ...
    public TradeOffer create(Entity entity, Random random) {
      experience = 2;
      List<ItemConvertible> logs = new ArrayList<>(Arrays
                                                       .asList(Blocks.ACACIA_LOG, Blocks.BIRCH_LOG, Blocks.DARK_OAK_LOG,
                                                               Blocks.JUNGLE_LOG, Blocks.OAK_LOG, Blocks.SPRUCE_LOG,
                                                               Blocks.STRIPPED_ACACIA_LOG, Blocks.STRIPPED_BIRCH_LOG,
                                                               Blocks.STRIPPED_DARK_OAK_LOG, Blocks.STRIPPED_JUNGLE_LOG,
  ...
  public static class DoorsForEmeralds extends SingleItemTypeTrade {
    ...
    public TradeOffer create(Entity entity, Random random) {
      experience = 10;
      List<Item> doors =
          random.nextFloat() < 0.5F ? ItemTags.WOODEN_DOORS.values() : ItemTags.WOODEN_TRAPDOORS.values();
      setInput(Items.EMERALD, 1);
      setOutput(doors.get(random.nextInt(doors.size())), 1);
      return super.create(entity, random);
    }
  ...
  public static class WorkstationForEmeralds extends SingleItemTypeTrade {
    ...
    public TradeOffer create(Entity entity, Random random) {
      ...
      if(ModuleHandler.enabled("beekeeper")) workstations.add(CustomWorkstationHandler.getWorkstation(Beekeeper.class));
